...
Bom:   Projetamos, fabricamos e montamos estruturas metálicas com equipe própria.
```
...
| Genérico | Específico |
|---|---|
| Soluções para o seu negócio | Galpões e mezaninos em estrutura metálica em Sorriso |
| Tudo o que você precisa | Peças de reposição para colheitadeiras, com estoque local |
| Transforme seus resultados | Contabilidade para transportadoras, com fechamento até o dia 5 |
| Feito para você | Camisas sob medida, prontas em 7 dias |
| Uma nova experiência | Consulta com retorno incluso em até 30 dias |
| Potencialize seu negócio | Sistema de pedidos que funciona no balcão e no delivery |
...
| Genérico | Real |
|---|---|
| Saiba mais | Ver nossos serviços |
| Comece agora | Pedir orçamento |
| Transforme seu negócio | Chamar no WhatsApp |
| Conheça nossas soluções | Ver produtos |
...
Produto/SaaS:   hero → produto → demonstração → funcionalidades → comparação → preço → FAQ
...
grep -rniE "inovador|revolucion|potencialize|transforme seu|eleve (o|sua|seu)|solução completa|experiência única|jornada|ecossistema|estratégic|solução inteligente|totalmente personalizad" $LP --include="*.html"

# estruturas típicas de texto gerado
grep -rniE "não é apenas .+\. é |mais do que .+, |de .+ a .+, (nós )?(fazemos|entregamos|oferecemos)" $LP --include="*.html"
...
Antes (genérico, com cara de gerado)
  Título:    Soluções completas para o seu negócio
  Subtítulo: Transforme seus resultados com uma experiência única — inovação e
             qualidade em uma jornada personalizada.
  CTA:       Saiba mais

Depois (específico, humano)
  Título:    Manutenção de empilhadeiras em Cuiabá, com atendimento no local
  Subtítulo: Nossa equipe vai até a sua empresa com peças no veículo. A maioria dos
             chamados é resolvida na primeira visita.
